...
@Slf4j
public class AvroJsonHttpMessageConverterTest {
    ...
    @BeforeEach
    void setUp() {
        avroHttpMessageConverter = new AvroJsonHttpMessageConverter<>(CompressorType.NONE);
    }
    ...
    void readInternalSingleObject() {
        Serializer ser = serializerFactory.serializer(AvroFormat.JSON, CompressorType.NONE);
    ...
    void writeInternalSingleObject() {
        ...
        try {
            ...
            Deserializer desr = deserializerFactory.deserializer(AvroFormat.JSON, CompressorType.NONE);
